...
MathProblem.create([
    { :math_problem_template_id => problem_templates[0],
    :problem_markup => '<mfrac><mrow><mn>-4</mn><mi>x</mi><mi>y</mi></mrow><mrow><mn>10</mn><mi>x</mi></mrow></mfrac>'},

    { :math_problem_template_id => problem_templates[1],
    ...
    { :math_problem_template_id => problem_templates[4],
    ...
    { :math_problem_template_id => problem_templates[5],
